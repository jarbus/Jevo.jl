...
exp_names = {"01-gravitar-nofa-01-25-25": "No Factorization",
             "02-gravitar-lora-01-25-25": "Low-Rank Factorization",
             "03-gravitar-nofa-small-01-25-25": "No Factorization (Small)"}
...
plt.legend()
plt.tight_layout()
plt.savefig("media/gravitar-reward.png")
plt.savefig("media/gravitar-reward.pdf")


nofa = exp_dfs["01-gravitar-nofa-01-25-25"]
fa = exp_dfs["02-gravitar-lora-01-25-25"]
nofa_small = exp_dfs["03-gravitar-nofa-small-01-25-25"]
