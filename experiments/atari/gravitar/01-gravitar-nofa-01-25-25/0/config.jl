...
geno_creator = Creator(Delta, Creator(JevoChain, (rng, gene_counter, [
    ...
    (Jevo.Conv, (kernel=(8,8), channels=3*env_args.n_stack=>32, stride=(4,4), σ=relu, )),
    (Jevo.Conv, (kernel=(4,4), channels=32=>64, stride=(2,2), σ=relu, )),
    (Jevo.Conv, (kernel=(3,3), channels=64=>64, stride=(1,1), σ=relu, )),
    Flux.flatten,
    (Jevo.Dense, (dims=(3136,256),σ=relu,  )),
