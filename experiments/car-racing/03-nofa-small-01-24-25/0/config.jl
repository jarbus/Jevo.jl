...
geno_creator = Creator(Delta, Creator(JevoChain, (rng, gene_counter, [
    (Jevo.Conv, (kernel=(4,4), channels=3*env_args.n_stack=>4, stride=(2,2), σ=relu, )),
    (Jevo.Conv, (kernel=(4,4), channels=4=>4, stride=(2,2), σ=relu, )),
    (Jevo.Conv, (kernel=(4,4), channels=4=>8, stride=(2,2), σ=relu, )),
    (Jevo.Conv, (kernel=(4,4), channels=8=>16, stride=(2,2), σ=relu, )),
    Flux.flatten,
    (Jevo.Dense, (dims=(64,32),σ=relu, )),
    (Jevo.Dense, (dims=(32,3),σ=identity))
])))
