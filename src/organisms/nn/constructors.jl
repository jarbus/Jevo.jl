NetworkGene(rng::AbstractRNG, counter::Counter, mr::Float32, init::Function=Jevo.apply_kaiming_normal_noise!) = 
    NetworkGene(inc!(counter), rand(rng, UInt64), mr, init, PoolInfo())
NetworkGene(counter::Counter, seed::UInt64, mr::Float32, init::Function, poolinfo::PoolInfo) = 
    NetworkGene(inc!(counter), seed, mr, init, poolinfo)
NetworkGene(id::Int, seed::UInt64, mr::Float32, init::Function) = 
    NetworkGene(id, seed, mr, init, PoolInfo())
